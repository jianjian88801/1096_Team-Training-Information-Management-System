  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='jiaolian'"  label='手机号' prop="jiaolianPhone">
               <el-input v-model="ruleForm.jiaolianPhone"  placeholder='手机号' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='球员姓名' prop="yonghuName">
               <el-input v-model="ruleForm.yonghuName"  placeholder='球员姓名' clearable></el-input>
           </el-form-item>
         </el-col>
