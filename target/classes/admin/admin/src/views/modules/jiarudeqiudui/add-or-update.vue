<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='qiudui' && role!= '教练'">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' && role!= '教练'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工资" prop="jiarudeqiuduiNumber">
                       <el-input v-model="ruleForm.jiarudeqiuduiNumber"
                                 placeholder="工资" clearable  :readonly="ro.jiarudeqiuduiNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="工资" prop="jiarudeqiuduiNumber">
                           <el-input v-model="ruleForm.jiarudeqiuduiNumber"
                                     placeholder="工资" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiarudeqiudui/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiarudeqiuduiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
