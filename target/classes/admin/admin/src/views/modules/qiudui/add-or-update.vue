    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaolian' ">
                    <el-form-item class="input" v-if="type!='info'"  label="手机号" prop="jiaolianPhone">
                        <el-input v-model="jiaolianForm.jiaolianPhone"
                                  placeholder="手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="手机号" prop="jiaolianPhone">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="球队名称" prop="qiuduiName">
                       <el-input v-model="ruleForm.qiuduiName"
                                 placeholder="球队名称" clearable  :readonly="ro.qiuduiName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="球队类型" prop="qiuduiTypes">
                        <el-select v-model="ruleForm.qiuduiTypes" :disabled="ro.qiuduiTypes" placeholder="请选择球队类型">
                            <el-option
                                v-for="(item,index) in qiuduiTypesOptions"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="所属地点" prop="qiuduiAddress">
                       <el-input v-model="ruleForm.qiuduiAddress"
                                 placeholder="所属地点" clearable  :readonly="ro.qiuduiAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="所属地点" prop="qiuduiAddress">
                           <el-input v-model="ruleForm.qiuduiAddress"
                                     placeholder="所属地点" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <input id="jiaolianId" name="jiaolianId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="球队简介" prop="qiuduiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.qiuduiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.qiuduiContent" label="球队简介" prop="qiuduiContent">
                            <span v-html="ruleForm.qiuduiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   qiuduiTypes: [
                              { required: true, message: '球队类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   qiuduiContent: [
                              { required: true, message: '球队简介不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=qiudui_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.qiuduiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`qiudui/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.qiuduiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
