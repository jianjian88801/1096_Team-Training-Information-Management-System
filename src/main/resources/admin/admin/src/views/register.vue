<template>
    <div style="backgroundImage: url('/qiuduixunlianxinxi/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">球队训练信息管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="手机号" class="input" v-if="tableName=='jiaolian'">
                            <el-input v-model="ruleForm.jiaolianPhone" autocomplete="off" placeholder="手机号"  />
                        </el-form-item>
                        ...
                        <el-form-item label="球员姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="球员姓名"  />
                        </el-form-item>
