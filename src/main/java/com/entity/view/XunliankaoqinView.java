...
public class XunliankaoqinView extends XunliankaoqinEntity implements Serializable {
	...
	public XunliankaoqinView() {

	}

	public XunliankaoqinView(XunliankaoqinEntity xunliankaoqinEntity) {
		try {
			BeanUtils.copyProperties(this, xunliankaoqinEntity);
